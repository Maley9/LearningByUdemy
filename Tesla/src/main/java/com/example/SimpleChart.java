...
public class SimpleChart extends JFrame {
    ...
    public SimpleChart(){
        ...
        JFreeChart chart = creativeChart(dataset);
        ...
        try{
            ...
            for(int i=0; i<stockHistory.size(); i++ ){
                ...
                series.add(new Day(calendar.get(Calendar.DAY_OF_MONTH),
                        calendar.get(Calendar.MONTH)+1, calendar.get(Calendar.YEAR)), quote.getClose());
    ...
    public JFreeChart creativeChart(XYDataset dataset){
